    ...
    return (
        <div className="container flex mx-auto max-w-screen-md items-center h-screen">
            ...
            <div className="flex flex-col w-2/5">
                <div className="flex flex-col items-center bg-black-hard p-4 border border-gray-primary mb-4 rounded">
            ...
            ${isInvalid && 'opacity-50'}`}
                ...
                <div className="flex justify-center items-center flex-col w-full bg-black p-4 rounded border border-gray-primary">
                    <p className="text-sm">
                        Have an account?{` `}
