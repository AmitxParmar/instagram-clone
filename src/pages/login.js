    ...
    return (
        <div className="container flex mx-auto max-w-screen-md items-center h-screen">
            ...
            <div className="flex flex-col w-2/5">
                <div className="flex flex-col items-center bg-white p4 border border-gray-primary mb-4">
                    <h1 className="flex justify-content w-full">
                        <img alt="Instagram Logo" src="../images/logo.png" className="mt-2 w-6/12 mb-4" />
                    </h1>
                    ...
                    <form onSubmit={handleLogin} method="POST">
                        ...
                        <input
                            autocomplete="email"
                            aria-label="Enter your email address" type="text" placeholder="Email address"
